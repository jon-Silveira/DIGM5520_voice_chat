const userStatus = {
  ...
  //  uses navigator.mediaDevices to get auido and video stream
    navigator.mediaDevices.getUserMedia({ audio: true }).then((stream) => {
      ...
      madiaRecorder.addEventListener("stop", function () {
        ...
        // uses fileReader to read the audo chunk
...
//emits the voice clip as a         
  ...
  // The below functions control the buttons on the page
